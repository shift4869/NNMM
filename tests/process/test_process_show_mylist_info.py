...
class TestProcessShowMylistInfo(unittest.TestCase):
    ...
    def test_PSMIrun(self):
        ...
        with ExitStack() as stack:
            ...
            mockle = stack.enter_context(patch("NNMM.process.process_show_mylist_info.logger.error"))
            mockuts = stack.enter_context(patch("NNMM.process.process_show_mylist_info.update_table_pane"))

            psmi = ProcessShowMylistInfo()
