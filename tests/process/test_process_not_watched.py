...
class TestProcessNotWatched(unittest.TestCase):
    ...
    def test_PNWrun(self):
        ...
        with ExitStack() as stack:
            ...
            mockuts = stack.enter_context(patch("NNMM.process.process_not_watched.update_table_pane"))
            mockums = stack.enter_context(patch("NNMM.process.process_not_watched.update_mylist_pane"))

            pnw = ProcessNotWatched()
