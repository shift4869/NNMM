...
from NNMM.process.process_search import ProcessMylistSearch, ProcessMylistSearchClear, ProcessMylistSearchFromVideo, ProcessVideoSearch, ProcessVideoSearchClear
...
class TestProcessSearch(unittest.TestCase):
    ...
    def test_PMSrun(self):
        ...
        with ExitStack() as stack:
            ...
            mockle = stack.enter_context(patch("NNMM.process.process_search.logger.error"))
            mocksgpgt = stack.enter_context(patch("NNMM.process.process_search.popup_get_text"))

            pms = ProcessMylistSearch()
    ...
    def test_PMSFVrun(self):
        ...
        with ExitStack() as stack:
            ...
            pmsfv = ProcessMylistSearchFromVideo()
    ...
    def test_PMSCrun(self):
        ...
        with ExitStack() as stack:
            mockli = stack.enter_context(patch("NNMM.process.process_search.logger.info"))
            mockle = stack.enter_context(patch("NNMM.process.process_search.logger.error"))
            mockums = stack.enter_context(patch("NNMM.process.process_search.update_mylist_pane"))

            pmsc = ProcessMylistSearchClear()
    ...
    def test_PVSCrun(self):
        ...
        with ExitStack() as stack:
            mockli = stack.enter_context(patch("NNMM.process.process_search.logger.info"))
            mockle = stack.enter_context(patch("NNMM.process.process_search.logger.error"))
            mockuts = stack.enter_context(patch("NNMM.process.process_search.update_table_pane"))

            pvsc = ProcessVideoSearchClear()
