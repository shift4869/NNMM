...
class TestNotWatched(unittest.TestCase):
    ...
    def test_run(self):
        with ExitStack() as stack:
            ...
            mock_selected_table_row_index_list = stack.enter_context(patch("NNMM.process.not_watched.ProcessBase.get_selected_table_row_index_list"))
            ...
            def pre_run(s_value, s_update_status):
                ...
                def f(video_id, mylist_url, status): return s_update_status
            ...
            def post_run(s_value, s_update_status):
                ...
                self.assertEqual([
                    call.update_status(s_video_id, s_mylist_url, "未視聴")
                ...
                self.assertEqual([
                    call.update_include_flag(s_mylist_url, True)
