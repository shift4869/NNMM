...
from NNMM.util import Result, find_values, get_mylist_type, get_now_datetime, interval_translate, is_mylist_include_new_video, load_mylist, popup_get_text, save_mylist, update_mylist_pane, update_table_pane
...
class TestUtil(unittest.TestCase):
    ...
    def test_update_mylist_pane(self):
        ...
        # 実行
        actual = update_mylist_pane(mockwin, m_cont)
    ...
    def test_update_table_pane(self):
        ...
        # 1回目の実行
        actual = update_table_pane(mockwin, m_cont, mb_cont)
        self.assertEqual(0, actual)
