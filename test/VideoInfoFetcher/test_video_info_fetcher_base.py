...
from NNMM.VideoInfoFetcher.video_info_fetcher_base import SourceType, VideoInfoFetcherBase
...
class TestVideoInfoFetcherBase(unittest.TestCase):
    ...
    def test_get_session_response(self):
        ...
        with ExitStack() as stack:
            mock_logger_error = stack.enter_context(patch("NNMM.VideoInfoFetcher.video_info_fetcher_base.logger.error"))
            mock_async_client = stack.enter_context(patch("NNMM.VideoInfoFetcher.video_info_fetcher_base.httpx.AsyncClient"))
    ...
    def test_fetch_videoinfo(self):
        ...
        """
        with ExitStack() as stack:
            mockle = stack.enter_context(patch("NNMM.VideoInfoFetcher.video_info_fetcher_base.logger.error"))
